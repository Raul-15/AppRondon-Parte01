...
import sebastiani.app_rondon.view.MainActivity
    ...
    private fun validateRegisterDetails(): Boolean {
        ...
        return when {
            ...
            TextUtils.isEmpty(et_confirm_password.text.toString().trim { it <= ' ' })
                    || !passwordRegex.matcher(et_confirm_password.toString()).matches() -> {
                showErrorSnackBar(
                ...
                .addOnCompleteListener(
                    OnCompleteListener<AuthResult> { task ->
                        ...
                        if (task.isSuccessful) {
                            ...
                            val intent =
                                Intent(this@RegisterActivity, MenuPrincipalActivity::class.java)
                            intent.flags =
